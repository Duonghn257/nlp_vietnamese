        ...
        with torch.no_grad():
            for step in range(max_new_tokens):
                ...
                if top_k > 0 and top_k < next_token_logits.size(-1):
                    ...
                    next_token_logits = next_token_logits.masked_fill(~top_k_mask, -50.0)
                ...
                if top_p < 1.0:
                    ...
                    next_token_logits = next_token_logits.masked_fill(indices_to_remove, -50.0)
                ...
                if do_sample:
                    ...
                    if torch.isnan(probs).any() or torch.isinf(probs).any() or (probs < 0).any():
                        ...
                        try:
                            ...
                            print(f"Warning: Multinomial sampling failed at step {step}: {e}")
